...
@app.route('/borrar_reiniciado_BD', methods=['GET'] )
def borrar_reiniciado_BD():
    datos=basedatos.checkDB()
...
app.config['UPLOAD_FOLDER'] = os.path.join(basedir, 'static/uploads') # you'll need to create a folder named uploads
...
def update_id(id):
    if request.method == 'GET':
        ...
        return render_template('update_id/index.html',
                                   datos=basedatos.consultarMenuID(id))
...
def DELETEALL():
    ...
    return jsonify(basedatos.borrrarMenuTODO())
...
#ver https://adictosaltrabajo.com/2024/02/21/diseno-y-renderizado-de-paginas-html-en-python-con-flask-guia-completa/
#https://github.com/TheKingOo/Python-Flask-CRUD-API/blob/main/app.py
#https://dataseoacademy.com/eliminar-un-archivo-en-python/
